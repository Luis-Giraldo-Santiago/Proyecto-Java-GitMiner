...
public class FindCommit {
    ...
    @JsonProperty("commit")
    public Com getCommits() {
        return commit;
    }

    @JsonProperty("commit")
    public void setCommits(Com commit) {
        this.commit = commit;
    }
    ...
    public String toString() {
        ...
        sb.append(FindCommit.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("sha");
        sb.append('=');
